      ...
      <div className="max-w-[1800px] mx-auto px-6 lg:px-12 py-16 lg:py-24">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          <div>
            ...
            <ul className="space-y-3">
              {['New Arrivals', 'Totes', 'Crossbody', 'Clutches', 'Bucket Bags', 'Sale'].map((item) => (
                <li key={item}>
          ...
          {/* Help */}
          <div>
            <h4 className="text-xs tracking-widest uppercase mb-6">Help</h4>
            <ul className="space-y-3">
          ...
          {/* About */}
          <div>
            <h4 className="text-xs tracking-widest uppercase mb-6">About</h4>
            <ul className="space-y-3">
        ...
        <div className="border-t border-gray-800 mt-16 pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
          ...
          <div className="flex items-center space-x-6">
            ...
            <a href={siteConfig.socialLinks.youtube} className="text-gray-400 hover:text-white transition-colors">
              <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
            ...
            <a href={siteConfig.socialLinks.telegram} className="text-gray-400 hover:text-white transition-colors">
              <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                <path d="M12 0C5.373 0 0 5.373 0 12s5.373 12 12 12 12-5.373 12-12S18.627 0 12 0zm5.894 8.221l-1.97 9.28c-.145.658-.537.818-1.084.508l-3-2.21-1.446 1.394c-.14.18-.357.295-.6.295l.213-3.054 5.56-5.022c.24-.213-.054-.334-.373-.121L8.32 13.617l-2.96-.924c-.64-.203-.658-.64.135-.954l11.566-4.458c.538-.196 1.006.128.832.941z"/>
              </svg>
            </a>
